...
chessField = [  # fieldKey, fieldNumber, figure, figureTexture, leftX, yAbove, centerX, centerY, fieldTexture, figureColor, colum, row
    ("8a", 1, "black_1_rook", dirLocation + "chessblack_2.png", 0 * mScreenW, 0 * mScreenH, 50 * mScreenW, 50 * mScreenH, white, "black", 1, 1), ("8b", 2, "black_knight", dirLocation + "chessblack_3.png", 100 * mScreenW, 0 * mScreenH, 150 * mScreenW, 50 * mScreenH, gray, "black", 1, 2), ("8c", 3, "black_bishop", dirLocation + "chessblack_4.png", 200 * mScreenW, 0 * mScreenH, 250 * mScreenW, 50 * mScreenH, white, "black", 1, 3), ("8d", 4, "black_queen", dirLocation + "chessblack_1.png", 300 * mScreenW, 0 * mScreenH, 350 * mScreenW, 50 * mScreenH, gray, "black", 1, 4), ("8e", 5, "black_king", dirLocation + "chessblack_0.png", 400 * mScreenW, 0 * mScreenH, 450 * mScreenW, 50 * mScreenH, white, "black", 1, 5), ("8f", 6, "black_bishop", dirLocation + "chessblack_4.png", 500 * mScreenW, 0 * mScreenH, 550 * mScreenW, 50 * mScreenH, gray, "black", 1, 6), ("8g", 7, "black_knight", dirLocation + "chessblack_3.png", 600 * mScreenW, 0 * mScreenH, 650 * mScreenW, 50 * mScreenH, white, "black", 1, 7), ("8h", 8, "black_2_rook", dirLocation + "chessblack_2.png", 700 * mScreenW, 0 * mScreenH, 750 * mScreenW, 50 * mScreenH, gray, "black", 1, 8),
    ("7a", 9, "black_pawn", dirLocation + "chessblack_5.png", 0 * mScreenW, 100 * mScreenH, 50 * mScreenW, 150 * mScreenH, gray, "black", 2, 1), ("7b", 10, "black_pawn", dirLocation + "chessblack_5.png", 100 * mScreenW, 100 * mScreenH, 150 * mScreenW, 150 * mScreenH, white, "black", 2, 2), ("7c", 11, "black_pawn", dirLocation + "chessblack_5.png", 200 * mScreenW, 100 * mScreenH, 250 * mScreenW, 150 * mScreenH, gray, "black", 2, 3), ("7d", 12, "black_pawn", dirLocation + "chessblack_5.png", 300 * mScreenW, 100 * mScreenH, 350 * mScreenW, 150 * mScreenH, white, "black", 2, 4), ("7e", 13, "black_pawn", dirLocation + "chessblack_5.png", 400 * mScreenW, 100 * mScreenH, 450 * mScreenW, 150 * mScreenH, gray, "black", 2, 5), ("7f", 14, "black_pawn", dirLocation + "chessblack_5.png", 500 * mScreenW, 100 * mScreenH, 550 * mScreenW, 150 * mScreenH, white, "black", 2, 6), ("7g", 15, "black_pawn", dirLocation + "chessblack_5.png", 600 * mScreenW, 100 * mScreenH, 650 * mScreenW, 150 * mScreenH, gray, "black", 2, 7), ("7h", 16, "black_pawn", dirLocation + "chessblack_5.png", 700 * mScreenW, 100 * mScreenH, 750 * mScreenW, 150 * mScreenH, white, "black", 2, 8),
    ...
    ("2a", 49, "white_pawn", dirLocation + "chesswhite_5.png", 0 * mScreenW, 600 * mScreenH, 50 * mScreenW, 650 * mScreenH, white, "white", 7, 1), ("2b", 50, "white_pawn", dirLocation + "chesswhite_5.png", 100 * mScreenW, 600 * mScreenH, 150 * mScreenW, 650 * mScreenH, gray, "white", 7, 2), ("2c", 51, "white_pawn", dirLocation + "chesswhite_5.png", 200 * mScreenW, 600 * mScreenH, 250 * mScreenW, 650 * mScreenH, white, "white", 7, 3), ("2d", 52, "white_pawn", dirLocation + "chesswhite_5.png", 300 * mScreenW, 600 * mScreenH, 350 * mScreenW, 650 * mScreenH, gray, "white", 7, 4), ("2e", 53, "white_pawn", dirLocation + "chesswhite_5.png", 400 * mScreenW, 600 * mScreenH, 450 * mScreenW, 650 * mScreenH, white, "white", 7, 5), ("2f", 54, "white_pawn", dirLocation + "chesswhite_5.png", 500 * mScreenW, 600 * mScreenH, 550 * mScreenW, 650 * mScreenH, gray, "white", 7, 6), ("2g", 55, "white_pawn", dirLocation + "chesswhite_5.png", 600 * mScreenW, 600 * mScreenH, 650 * mScreenW, 650 * mScreenH, white, "white", 7, 7), ("2h", 56, "white_pawn", dirLocation + "chesswhite_5.png", 700 * mScreenW, 600 * mScreenH, 750 * mScreenW, 650 * mScreenH, gray, "white", 7, 8),
    ("1a", 57, "white_1_rook", dirLocation + "chesswhite_2.png", 0 * mScreenW, 700 * mScreenH, 50 * mScreenW, 750 * mScreenH, gray, "white", 8, 1), ("1b", 58, "white_knight", dirLocation + "chesswhite_3.png", 100 * mScreenW, 700 * mScreenH, 150 * mScreenW, 750 * mScreenH, white, "white", 8, 2), ("1c", 59, "white_bishop", dirLocation + "chesswhite_4.png", 200 * mScreenW, 700 * mScreenH, 250 * mScreenW, 750 * mScreenH, gray, "white", 8, 3), ("1d", 60, "white_queen", dirLocation + "chesswhite_1.png", 300 * mScreenW, 700 * mScreenH, 350 * mScreenW, 750 * mScreenH, white, "white", 8, 4), ("1e", 61, "white_king", dirLocation + "chesswhite_0.png", 400 * mScreenW, 700 * mScreenH, 450 * mScreenW, 750 * mScreenH, gray, "white", 8, 5), ("1f", 62, "white_bishop", dirLocation + "chesswhite_4.png", 500 * mScreenW, 700 * mScreenH, 550 * mScreenW, 750 * mScreenH, white, "white", 8, 6), ("1g", 63, "white_knight", dirLocation + "chesswhite_3.png", 600 * mScreenW, 700 * mScreenH, 650 * mScreenW, 750 * mScreenH, gray, "white", 8, 7), ("1h", 64, "white_2_rook", dirLocation + "chesswhite_2.png", 700 * mScreenW, 700 * mScreenH, 750 * mScreenW, 750 * mScreenH, white, "white", 8, 8)
]
...
def figureMove(sourceIndex, moveToIndex, automatic=False, illegalMoveTest=False):  # Funktion, die Figuren bewegt / die Schachfeldliste an den bestimmten Stellen überschreibt
    ...
    sFieldKey, sFieldNumber, sFigure, sFigureTexture, sLeftX, sYAbove, sCenterX, sCenterY, sFieldTexture, sFigureColor, sColum, sRow = sourceField  # Entpacken des source_fields
    mFieldKey, mFieldNumber, mFigure, mFigureTexture, mLeftX, mYAbove, mCenterX, mCenterY, mFieldTexture, mFigureColor, mColum, mRow = moveToField  # Entpacken des move_to_fields
    ...
    if len(rochadeFigurePlace) != 0:  # Falls eine Rochade durchgeführt werden könnte
        for t in rochadeFigurePlace:
            ...
            if clickedField - 1 == moveToIndex:  # Prüft für jede Rochade, die in diesem Zug hätte durchgeführt werden können, ob sie durchgeführt wurde
                ...
                kingField = chessField[
                    kFieldNumber - 1]  # weder source noch moveto Feld, da sich König und Turm bei der Rochade auf andere Felder bewegen, weshalb hier diese Felder entpackt werden müssen
                rookField = chessField[
                    rookFieldNumber - 1]  # weder source noch moveto Feld, da sich König und Turm bei der Rochade auf andere Felder bewegen, weshalb hier diese Felder entpackt werden müssen
    ...
    chessField[sourceIndex] = (sFieldKey, sFieldNumber, sFigure, sFigureTexture, sLeftX, sYAbove, sCenterX, sCenterY, sFieldTexture, sFigureColor, sColum, sRow)
    chessField[moveToIndex] = (mFieldKey, mFieldNumber, mFigure, mFigureTexture, mLeftX, mYAbove, mCenterX, mCenterY, mFieldTexture, mFigureColor, mColum, mRow)
