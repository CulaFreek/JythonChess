...
def repaint():  # Neu zeichen des Schachfeldes nach einer Bewegung --->>> Einfachste Möglichkeit Figur texturen wieder vom Feld zu entfernen
    ...
    gt.setTitle("Du bist " + yourColor + "  -  Aktiver Spieler : " + activePlayerText + "  |    " + str(moves) + "  :  Züge insgesamt --- Spielzeit :  " + str(int(timer)) + " min")  # Nur in Minuten, da Timer nicht fortlaufend, sondern nur bei Aktionen aktualisiert wird
    gt.repaint()
...
def decolor(notMoved=False):  # Funktion zum Entfärben der gefärbten Felder
