...
def getMove():
    OneDeviceChess.selectedField = []
    fieldKey, fieldNumber, figure, figureTexture, leftX, yAbove, centerX, centerY, fieldTexture, figureColor, column, row = OneDeviceChess.chessField[9]
    OneDeviceChess.selectedField.append((centerX, centerY, fieldTexture, figure, fieldNumber, column, row))
    OneDeviceChess.selectedField.append(0)
    move = OneDeviceChess.possiblePawnMoves()
    print(move)
    return move
